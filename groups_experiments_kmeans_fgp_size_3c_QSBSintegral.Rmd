---
title: "Experiments with groups of stations: using kmeans for 3 clusters with catchment_size and fpg as params"
author: "FBK"
date: "9 januar 2017"
output: 
  html_document:
...
to_cluster <- na.omit(data.frame(fgp = fgp_normalized, area = area_normalized, index = initial_index))

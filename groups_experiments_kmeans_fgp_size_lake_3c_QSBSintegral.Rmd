---
title: "Experiments with groups of stations: using kmeans for 3 clusters with lake_perc, catchment_size and fpg as params"
author: "FBK"
date: "9 januar 2017"
output: 
  html_document:
...
initial_index <- seq(along = flood_metadata$median_fgp)
to_cluster <- na.omit(data.frame(fgp = fgp_normalized, lake = lake_normalized, 
                                 area = area_normalized, index = initial_index))

set.seed(20)
stationsCluster <- kmeans(to_cluster[1:3], 3, nstart = 20)
...
scatter3D(x = to_cluster$fgp, y = to_cluster$lake, z = to_cluster$area, colvar = stationsCluster$cluster,
pch = 16, cex = 1.5, xlab = "fgp", ylab = "lake",
zlab = "area")
...
```{r QS_3paramClust_q25q50q75,  results = "asis", fig.height= 10, fig.width= 15, fig.keep = "all", fig.align='center'}
gof_type <- "BS"
returnPeriod <- 2
...
```{r BS_3paramClust_q25q50q75,  results = "asis", fig.height= 10, fig.width= 15, fig.keep = "all", fig.align='center'}
gof_type <- "BS"
returnPeriod <- 2

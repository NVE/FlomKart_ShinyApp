...
```{r QS_area_q25q50q75,  results = "asis", fig.height= 10, fig.width= 15, fig.keep = "all", fig.align='center'}
gof_type <- "QS"
returnPeriod <- 2
...
```{r BS_area_q25q50q75,  results = "asis", fig.height= 10, fig.width= 15, fig.keep = "all", fig.align='center'}
gof_type <- "BS"
returnPeriod <- 2

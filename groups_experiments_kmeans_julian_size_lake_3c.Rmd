---
title: "Experiments with groups of stations: using kmeans for 4 clusters with lake_perc, catchment_size and julian as params"
author: "FBK"
date: "9 januar 2017"
output: 
  html_document:
...
to_cluster <- na.omit(data.frame(julian_day = julian_normalized, lake = lake_normalized, area = area_normalized, index = initial_index))

set.seed(20)
stationsCluster <- kmeans(to_cluster[1:3], 4, nstart = 20)
...
scatter3D(x = to_cluster$julian_day, y = to_cluster$lake, z = to_cluster$area, colvar = stationsCluster$cluster,
pch = 16, cex = 1.5, xlab = "julian", ylab = "lake",
zlab = "area")
